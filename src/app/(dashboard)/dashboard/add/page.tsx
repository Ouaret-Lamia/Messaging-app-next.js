...
const page = async () => {
  ...
  return (
    <main className="w-full">
      <div className="flex flex-col items-center justify-center w-full py-15 rounded-lg shadow-md bg-white">
        <h1 className="font-bold text-4xl mb-8 text-rose-900">Add a friend</h1>
        <AddFriendButton />
      </div>

      <div className="w-full p-6 rounded-lg shadow-md mt-4 bg-white">
